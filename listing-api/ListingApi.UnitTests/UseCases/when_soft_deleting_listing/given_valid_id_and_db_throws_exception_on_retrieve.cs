...
namespace ListingApi.UnitTests.UseCases.when_soft_deleting_listing
{
    ...
    public class given_valid_id_and_db_throws_exception_on_retrieve : IAsyncLifetime
    {
        private readonly TestHostFixture _fixture;
        private HttpResponseMessage _response;
        
        public given_valid_id_and_db_throws_exception_on_retrieve(TestHostFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task InitializeAsync()
        {
            ...
            _fixture.Factory.MockedListingStoreAccess.Setup(service => service.GetListing(It.IsAny<string>()))
                .Throws(new CosmosRetrieveListingException("Exception"));
