...
namespace ListingApi.UnitTests.UseCases.when_updating_listing
{
    ...
    public class given_listing_dto_missing_required_fields : IAsyncLifetime
    {
        private readonly TestHostFixture _fixture;
        private HttpResponseMessage _response;

        public given_listing_dto_missing_required_fields(TestHostFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        [Fact]
        public void then_the_UpdateListing_method_should_not_have_been_called_once()
        {
